...
\subsection{Results}
To interpret our result tables, we provide a key for abbreviations. Overall $= \dfrac{\#\:correct}{total\:samples}$, P.P is the positive sample precision, P.R is the positive sample recall, and P.F1 is the positive sample F1 score. Negative sample results are abbreviated identically. 
